...
const UserUpdateDetails = () => {
  ...
  const handleUser: SubmitHandler<AccountFormData> = async (data) => {
    const { username } = data;
    try {
          ...
          <CardContent>
            ...
            >
              ...
              <Button
                ...
                className="bg-indigo-950 text-slate-100 hover:text-slate-300 transition-all duration-200 hover:bg-indigo-950"
              >
                {isSubmittingAccount ? (
                  <>
